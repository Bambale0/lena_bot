const translations = {
  ru: {
    nav: { features: "Возможности", examples: "Примеры", models: "Модели", how: "Как это работает", pricing: "Цены", cta: "Открыть бота" },
    hero: {
    ...
    panel: {
      ...
      live: "Актуальные тарифы",
      liveText: "Тарифы приходят с live API, поэтому лендинг показывает те же цены, что и бот.",
    },
    features: {
    ...
    pricing: {
      ...
      subtitle: "Цены подгружаются с live API, поэтому лендинг показывает актуальные тарифы без ручного обновления.",
      starter: {
        badge: "Старт",
        title: "15 бонусных кредитов",
        text: "Хватает, чтобы протестировать реальные сценарии: изображение, видео, музыку или первый ремикс.",
        items: ["Доступ через Telegram-бота", "Изображения, видео, музыка и лента", "Промпты, референсы и remix-flow"],
        cta: "Открыть бота",
      },
      planCta: "Открыть бота",
      planMeta: "Актуальный тариф из API",
  ...
  en: {
    nav: { features: "Features", examples: "Examples", models: "Models", how: "How it works", pricing: "Pricing", cta: "Open bot" },
    hero: {
    ...
    panel: {
      ...
      live: "Live pricing",
      liveText: "Pricing is fetched from the live API, so the landing stays aligned with the bot.",
    },
    features: {
    ...
    pricing: {
      ...
      subtitle: "This section is loaded from the live backend API, so pricing stays current without manual updates.",
      starter: {
        badge: "Starter",
        title: "15 bonus credits",
        text: "Enough to test real flows: an image, a video, a track, or your first remix.",
        items: ["Access via Telegram bot", "Images, video, music, and feed", "Prompts, references, and remix flow"],
        cta: "Open bot",
      },
      planCta: "Open bot",
      planMeta: "Current plan from the API",
