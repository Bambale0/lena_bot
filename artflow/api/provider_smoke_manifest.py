...
def _base_case(contract_id: str) -> dict[str, Any]:
    ...
    primary_video: dict[str, dict[str, Any]] = {
        ...
        "video.minimaxh3.t2v": {"prompt": "A paper lantern floats through a quiet courtyard", "duration": 4, "resolution": "768P", "aspect_ratio": "16:9"},
        "video.minimaxh3.i2v": {"prompt": "Animate the reference naturally", "image_url": IMAGE_URL, "duration": 4},
        "video.minimaxh3.reference": {"prompt": "Follow the supplied visual motion and audio references", "image_url": IMAGE_URL, "reference_video_url": VIDEO_URL, "audio_ids": [AUDIO_URL], "duration": 4, "aspect_ratio": "adaptive"},
