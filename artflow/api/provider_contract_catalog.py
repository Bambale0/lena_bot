...
VIDEO_CONTRACTS = (
    ...
    _c("video.seedance25", "kie", "bytedance/seedance-2-5", ("text", "image"), ("https://docs.kie.ai/market/bytedance/seedance-2-5",), _VIDEO_BACKEND, ("tests/test_seedance25_admin_model_visibility.py",), smoke="video.seedance25", **_VIDEO_SURFACES),
