...
VIDEO_CONTRACTS = (
    ...
    _c("video.minimaxh3.t2v", "kie", "minimax-h3/text-to-video", ("text",), ("https://docs.kie.ai/market/minimax-h3/text-to-video",), _VIDEO_BACKEND, ("tests/test_minimax_h3_adapter.py",), smoke="video.minimaxh3.t2v", **_VIDEO_SURFACES),
    _c("video.minimaxh3.i2v", "kie", "minimax-h3/image-to-video", ("first_frame", "first_last"), ("https://docs.kie.ai/market/minimax-h3/image-to-video",), _VIDEO_BACKEND, ("tests/test_minimax_h3_adapter.py",), smoke="video.minimaxh3.i2v", **_VIDEO_SURFACES),
    _c("video.minimaxh3.reference", "kie", "minimax-h3/reference-to-video", ("reference_image", "reference_video", "reference_audio", "multimodal"), ("https://docs.kie.ai/market/minimax-h3/reference-to-video",), _VIDEO_BACKEND, ("tests/test_minimax_h3_adapter.py",), smoke="video.minimaxh3.reference", **_VIDEO_SURFACES),
