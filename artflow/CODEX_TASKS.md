...
- `nano-banana-2`, `nano-banana-pro`, GPT Image 2 и VIP-варианты используют NexusAPI как primary provider; Seedream 5 Pro использует KIE.AI Market
...
1. При создании асинхронной image-задачи обязательно передавать callback URL. Nexus-модели (`nano-banana-2`, `nano-banana-pro`, GPT Image 2 и VIP-варианты) получают тот же callback через `webhook_url`; Seedream 5 Pro и остальные KIE-модели используют KIE callback contract.
