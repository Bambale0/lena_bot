...
def test_seedance25_miniapp_control_tokens_ignore_legacy_scenario():
    ...
    audio_refs, video_refs, options = _control_payload(
        [
            ...
            "__apix_seedance25:return_last_frame=true",
            "__apix_seedance25:web_search=true",
            "__apix_seedance25:video_ref=https://cdn.example/ref.mp4",
            "__apix_seedance25:audio_ref=https://cdn.example/ref.mp3",
        ]
    )
...
def test_seedance25_model_picker_is_public_and_enhancer_is_automatic_multimodal():
    ...
    assert "bytedance/seedance-2-5" in enhancer
    assert "generate_audio" in enhancer
