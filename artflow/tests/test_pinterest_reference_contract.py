...
def test_pinterest_contract_keeps_product_roles_and_provider_safe_order() -> None:
    ...
    assert contract["provider_reference_roles"] == ["identity", "scene", "identity_evidence"]
...
@pytest.mark.asyncio
async def test_provider_wrapper_sends_identity_scene_then_extra_identity_evidence() -> None:
