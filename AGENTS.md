# AGENTS.md — APIX Repository Instructions

The production application lives under `artflow/`. Agents working in that subtree must also read and obey `artflow/AGENTS.md`, which contains APIX-specific parity, safety, testing, and delivery rules.
